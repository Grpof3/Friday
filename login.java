...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/client?zeroDateTimeBehavior=convertToNull","root","");
            st = conn.createStatement();
            JOptionPane.showMessageDialog(null,"Connected");
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,e+"Not Connected to database!");
